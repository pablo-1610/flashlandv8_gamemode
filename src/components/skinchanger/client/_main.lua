...
_FlashClient_SkinChanger.getMaxValues = function()
...
_FlashClient_SkinChanger.applySkin = function(skin)
    local playerPed = PlayerPedId()
...
_FlashClient_SkinChanger.getCharacter = function()
    return (Character)
end

_FlashClient_SkinChanger.setAllToDefault = function()
    local newCharacter = {}
    for k, v in pairs(components) do
        newCharacter[v.name] = v.value
    end
    _FlashClient_SkinChanger.applySkin(newCharacter)
...
_FlashLand.loadedComponent("skinchanger")